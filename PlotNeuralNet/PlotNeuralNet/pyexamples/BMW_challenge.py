...
arch = [
    ...
    *block_2ConvPool(name='b2', botton='pool_b1', top='pool_b2', s_filer=256, n_filer=128, offset="(1,0,0)",
                     size=(32, 32, 3.5), opacity=0.5, caption="VAE Encoder"),
    ...
    *block_2ConvPool(name='b4', botton='pool_b3', top='pool_b4', s_filer=64, n_filer=512, offset="(1,0,0)",
    ...
    to_ConvConvRelu(name='ccr_b5', s_filer=32, n_filer=(1024, 1024), offset="(2,0,0)", to="(pool_b4-east)",
                    width=(16,16), height=16, depth=16, caption="Boson Sampler"),
    to_connection("pool_b4", "ccr_b5"),
*   block_2ConvPool(name='b5_unet', botton='ccr_b5', top='pool_b5_unet', s_filer=16, n_filer=2048, offset="(1,0,0)",
                     size=(8, 8, 5.5), opacity=0.5),
    to_connection("ccr_b5", "pool_b5_unet"),
    *block_Unconv(name="b_unet", botton="pool_b5_unet", top='end_b_unet', s_filer=8, n_filer=2048, offset="(2.1,0,0)",
                  size=(5, 5, 5.0), opacity=0.5, caption="Unet"),
    to_connection("pool_b5_unet", "end_b_unet"),
    *block_Unconv(name="b_unet_2", botton="end_b_unet", top='end_b_unet_2', s_filer=16, n_filer=2048, offset="(2.1,0,0)",
                  size=(8, 8, 5.5), opacity=0.5),
    to_skip(of='ccr_b5_unet', to='ccr_res_b_unet_2', pos=1.25),
    # Decoder
    *block_Unconv(name="b6", botton="end_b_unet_2", top='end_b6', s_filer=64, n_filer=512, offset="(2.1,0,0)",
    ...
    *block_Unconv(name="b9", botton="end_b8", top='end_b9', s_filer=512, n_filer=64, offset="(2.1,0,0)",
                  size=(40, 40, 2.5), opacity=0.5, caption="VAE decoder"),
