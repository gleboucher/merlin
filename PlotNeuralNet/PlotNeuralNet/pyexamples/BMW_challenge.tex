...
\node (input) [opacity=1][canvas is zy plane at x=0] at (-2,0,0) {\includegraphics[width=2cm,height=2cm]{car.jpg}};
...
\pic[shift={ (2,0,0) }] at (pool_b4-east) 
    {RightBandedBox={
        name=ccr_b5,
        caption=\scriptsize Boson Sampler,
        fill=\ConvColor,
        bandfill=\ConvReluColor,
        height=16,
        width={ 16 , 16 },
...
\pic[shift={ (0,0,0) }] at (ccr_b5_unet-east) 
    {Box={
        name=pool_b5_unet,
        caption= ,
        fill=\PoolColor,
...
\draw [connection]  (ccr_b5-east)    -- node {\midarrow} (ccr_b5_unet-west);

\draw [connection]  (ccr_b5-east)    -- node {\midarrow} (pool_b5_unet-west);

\pic[shift={ (2.1,0,0) }] at (pool_b5_unet-east) 
    {Box={
        name=unpool_b_unet,
        caption= ,
        fill=\UnpoolColor,
...
\pic[shift={ (0,0,0) }] at (unpool_b_unet-east) 
    {RightBandedBox={
        name=ccr_res_b_unet,
        caption=Unet,
...
\pic[shift={(0,0,0)}] at (ccr_res_b_unet-east) 
    {Box={
        name=ccr_b_unet,
        caption=\scriptsize  ,
        fill=\ConvColor,
...
\pic[shift={ (0,0,0) }] at (ccr_b_unet-east) 
    {RightBandedBox={
        name=ccr_res_c_b_unet,
        caption= ,
        fill={rgb:white,1;black,3},
        bandfill={rgb:white,1;black,2},
        opacity=0.5,
...
\pic[shift={(0,0,0)}] at (ccr_res_c_b_unet-east) 
    {Box={
        name=end_b_unet,
        caption=\scriptsize  ,
        fill=\ConvColor,
...
\draw [connection]  (pool_b5_unet-east)    -- node {\midarrow} (unpool_b_unet-west);

\draw [connection]  (pool_b5_unet-east)    -- node {\midarrow} (end_b_unet-west);

\pic[shift={ (2.1,0,0) }] at (end_b_unet-east) 
    {Box={
        name=unpool_b_unet_2,
        caption= ,
        fill=\UnpoolColor,
        opacity=0.5,
        height=8,
...
\pic[shift={ (0,0,0) }] at (unpool_b_unet_2-east) 
    {RightBandedBox={
        name=ccr_res_b_unet_2,
        caption= ,
        fill={rgb:white,1;black,3},
        bandfill={rgb:white,1;black,2},
        opacity=0.5,
...
\pic[shift={(0,0,0)}] at (ccr_res_b_unet_2-east) 
    {Box={
        name=ccr_b_unet_2,
        caption=\scriptsize  ,
        fill=\ConvColor,
...
\pic[shift={ (0,0,0) }] at (ccr_b_unet_2-east) 
    {RightBandedBox={
        name=ccr_res_c_b_unet_2,
        caption= ,
        fill={rgb:white,1;black,3},
        bandfill={rgb:white,1;black,2},
        opacity=0.5,
...
\pic[shift={(0,0,0)}] at (ccr_res_c_b_unet_2-east) 
    {Box={
        name=end_b_unet_2,
        caption=\scriptsize  ,
        fill=\ConvColor,
...
\draw [connection]  (end_b_unet-east)    -- node {\midarrow} (unpool_b_unet_2-west);

\path (ccr_b5_unet-southeast) -- (ccr_b5_unet-northeast) coordinate[pos=1.25] (ccr_b5_unet-top) ;
\path (ccr_res_b_unet_2-south)  -- (ccr_res_b_unet_2-north)  coordinate[pos=1.25] (ccr_res_b_unet_2-top) ;
\draw [copyconnection]  (ccr_b5_unet-northeast)  
-- node {\copymidarrow}(ccr_b5_unet-top)
-- node {\copymidarrow}(ccr_res_b_unet_2-top)
-- node {\copymidarrow} (ccr_res_b_unet_2-north);

\pic[shift={ (2.1,0,0) }] at (end_b_unet_2-east) 
    {Box={
        name=unpool_b6,
        caption= ,
        fill=\UnpoolColor,
...
\draw [connection]  (end_b_unet_2-east)    -- node {\midarrow} (unpool_b6-west);
